...
@Component({
  selector: 'app-agregar-cliente-sc',
  templateUrl: './agregar-cliente-sc.component.html',
  styleUrls: ['./agregar-cliente-sc.component.css']
})
export class AgregarClienteScComponent implements OnInit {
