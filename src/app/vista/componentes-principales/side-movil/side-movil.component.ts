      ...
      this.servicioAcceso.listarTodos().subscribe( res =>{
        ...
        for (let i = 0; i < this.listaAccessForm.length; i++) {
          if(this.listaAccessForm[i] == 5 || this.listaAccessForm[i] == 4 || this.listaAccessForm[i] == 3 || this.listaAccessForm[i] == 10 || this.listaAccessForm[i] == 11 || this.listaAccessForm[i] == 19 || this.listaAccessForm[i] == 21){
            ...
            document.getElementById('MatrizDeNecesidades2')?.setAttribute('style', 'display: block;')
          }
          ...
          if (this.listaAccessForm[i] == 60) {
            document.getElementById('6060')?.setAttribute('style', 'display: block;')
          }
          if (this.listaAccessForm[i] == 61) {
            document.getElementById('6161')?.setAttribute('style', 'display: block;')
          }
          if (this.listaAccessForm[i] == 62) {
            document.getElementById('6262')?.setAttribute('style', 'display: block;')
          }
          if (this.listaAccessForm[i] == 63) {
            document.getElementById('6363')?.setAttribute('style', 'display: block;')
          }
          if (this.listaAccessForm[i] == 64) {
            document.getElementById('6464')?.setAttribute('style', 'display: block;')
          }
          if (this.listaAccessForm[i] == 65) {
            document.getElementById('6565')?.setAttribute('style', 'display: block;')
          }
        }
      })
    })
