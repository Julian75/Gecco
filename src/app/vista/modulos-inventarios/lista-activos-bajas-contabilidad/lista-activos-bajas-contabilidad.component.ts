...
@Component({
  selector: 'app-lista-activos-bajas-contabilidad',
  templateUrl: './lista-activos-bajas-contabilidad.component.html',
  styleUrls: ['./lista-activos-bajas-contabilidad.component.css']
})
export class ListaActivosBajasContabilidadComponent implements OnInit {
  dtOptions: any = {};
  ...
  public aprobarActivo(id: any){
    let solicitudBajasArticulo: SolicitudBajasArticulos2 = new SolicitudBajasArticulos2();
    this.serviceSolicitudBajasArticulos.listarPorId(id).subscribe(resSolicitudBaja=>{
      solicitudBajasArticulo.id = resSolicitudBaja.id;
      solicitudBajasArticulo.fecha = resSolicitudBaja.fecha;
      solicitudBajasArticulo.id_usuario = resSolicitudBaja.idUsuario.id;
      solicitudBajasArticulo.id_estado = resSolicitudBaja.idEstado.id;
      solicitudBajasArticulo.usuario_autorizacion = resSolicitudBaja.usuarioAutorizacion;
      solicitudBajasArticulo.usuario_confirmacion = resSolicitudBaja.usuarioConfirmacion;
      solicitudBajasArticulo.estado_contabilidad = "Aprobado";
      this.servicioModificar.actualizarSolicitudBajaArticulo(solicitudBajasArticulo).subscribe(resModificarSolicitudBaja=>{
        Swal.fire({
          position: 'center',
          icon: 'success',
